			...
			<section class="col-md-10">
				<div class="row">
					<article class="col-md-8">
						<img class="img-responsive" src="../vue/images/1.jpg" />
						<p>Charles Michel avec les étudiants en Erasmus</p>
					</article>
					<article class="col-md-4">
						<img class="img-responsive" src="../vue/images/2.jpg" />
						<p>COP23:"La Belgique partage le sentiment d'urgence et agit</p>
					</article>
					<article class="col-md-4">
						<img class="img-responsive" src="../vue/images/3.jpg" />
						<p>Le journaliste Hugo Clément quitte «Quoditien»</p>
					</article>
					<article class="col-md-4">
						<img class="img-responsive" src="../vue/images/4.jpg" />
						<p>Un sanglier coincé dans une piscine à Erpent</p>
					</article>
					<article class="col-md-8">
						<img class="img-responsive" src="../vue/images/5.jpg" />
